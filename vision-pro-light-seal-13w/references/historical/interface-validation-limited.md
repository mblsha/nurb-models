# Historical limited Light Seal interface validation

This report is superseded. It records the older limited checks, not current acceptance. Read `../interface-validation-latest.json` and `../independent-scan-validation.md` for current status.
